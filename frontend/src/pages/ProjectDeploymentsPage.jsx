...
import { CaretRight, Rocket, Sparkle } from "@phosphor-icons/react";
      ...
      <div className="flex-1 flex items-center justify-center p-8 min-h-[calc(100vh-12rem)]">
        <div className="text-center max-w-md">
          ...
          <p className="text-slate-400 text-sm mb-6 leading-relaxed">
            Publish your site to custom domains with one click. Track deployment
            history, rollback to previous versions, and manage environments.
          </p>
