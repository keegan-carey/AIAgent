...
import { CaretRight, MagnifyingGlass, Sparkle } from "@phosphor-icons/react";
      ...
      <div className="flex-1 flex items-center justify-center p-8 min-h-[calc(100vh-12rem)]">
        <div className="text-center max-w-md">
          <div className="w-16 h-16 rounded-2xl bg-slate-900 border border-slate-800 flex items-center justify-center mx-auto mb-6">
            <MagnifyingGlass className="text-slate-500" size={32} />
          </div>
          <h1 className="text-2xl font-bold text-white mb-2">SEO</h1>
          <p className="text-slate-400 text-sm mb-6 leading-relaxed">
            Optimize meta tags, Open Graph previews, sitemaps, and search engine
            visibility for every page in your project.
          </p>
